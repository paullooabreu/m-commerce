...
import com.abreu.mcommerce.data.NavMenuItensDataBase
...
//        }
    ...
    private fun initNavMenuItems(){
        ...
        rv_menu_items.adapter = NavMenuItemAdapter(NavMenuItensDataBase(this).items)
    }
    ...
    private fun initNavMenuItemsLogged(){
        ...
        rv_menu_items_logged.adapter = NavMenuItemAdapter(NavMenuItensDataBase(this).itemsLogger)
    }
